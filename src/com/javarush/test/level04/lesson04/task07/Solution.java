...
public class Solution {
    public static void main(String[] args) throws Exception {
        checkYear(new Scanner(System.in).nextInt());
    }
...
//        }
        // non-leap IF year isn't multiple 4 OR if year is multiple 4 AND year is multiple 100 AND year isn't multiple 400
